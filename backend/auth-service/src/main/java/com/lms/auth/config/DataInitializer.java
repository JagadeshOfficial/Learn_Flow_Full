...
/**
 * DataInitializer - Seeds demo data for H2 in-memory database during development
 * 
 * IMPORTANT:
 ...
 * - Do NOT add multiple admins here; if you need more admins, add them directly to your database
 * 
 ...
 */
@Configuration
@Profile("h2")  // This bean only activates when h2 profile is active
